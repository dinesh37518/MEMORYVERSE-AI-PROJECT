...
const STORAGE_KEY = 'memoryverse_groq_api_key';
const PROMPT_STORAGE_KEY = 'memoryverse_custom_groq_prompt';

export const getStoredApiKey = (): string => {
  if (typeof window !== 'undefined') {
    return localStorage.getItem(STORAGE_KEY) || (import.meta as any).env?.VITE_GROQ_API_KEY || '';
  }
  return '';
};
