...
export const INITIAL_TIMELINE: TimelineEvent[] = [
  ...
  },
  {
    ...
    category: 'Internships',
    description: '1-month full stack web development internship with Angular, Node.js, and MySQL.',
    documentId: 'doc_intern_neuro',
